...
ActiveRecord::Schema.define(version: 20_230_126_101_629) do
  ...
  create_table 'shipping_free_statuses', options: 'ENGINE=InnoDB DEFAULT CHARSET=utf8', force: :cascade do |t|
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
  end
